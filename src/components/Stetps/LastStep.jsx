export const LastStep = () => {
  return (
    <div className="flex w-[480] gap-2 flex-col p-8 items-start bg-[#FFF] border-0 rounded-lg h-[193px]">
      <div>
        <img
          className="w-[60px] h-[60px] aspect-square"
          ...
          alt=" logo"
        />
        <p className="text-[#202124] text-[26px] not-italic font-semibold leading-6 ">
          You're All Set 🔥
        </p>
        <p className="text-[#8E8E8E] text-lg not-italic font-normal ">
